...
description: "[v2 — нейроответы] Generates SEO-optimized HTML category page blocks for the GOODMi online store. v2 changes: FAQ moved to Block 1 (always visible, not behind collapse), 5 FAQ questions (adds informational question first), sameAs in LocalBusiness JSON-LD, HowTo JSON-LD template (optional), concrete-numbers requirement in .gm-intro-text. Use when the user provides a product category or device model and asks to create/write/generate an SEO page, category block, or HTML content for product category sections."
---

# SEO Shop Page Builder v2 — GOODMi
...
> 6. **Конкретные числа** в `.gm-intro-text` — обязательная проверка
...
Если в категории присутствует 2+ бренда (Dreame, Roborock, Marshall, JBL, Amazfit и т.п.) — **до генерации HTML** выполнить Step 2a-multi для каждого вторичного бренда.

### [v2] Step 2a-multi — SERP по вторичным брендам

**Когда:** страница содержит бренды помимо Xiaomi.
...
Для любой категории Xiaomi / Redmi / POCO / Amazfit — **обязательно** проверять кириллические LSI-варианты:
...
- Ровно **5 вопросов**, покрывающих 5 интентов:
  1. **[v2] Информационный** — «Что важно учесть при выборе [категория] Xiaomi?» *(добавлен в v2)*
  2. **Сравнение моделей** — «Чем [Модель A] отличается от [Модель B]?»
  3. **Доставка** — «Как купить [категория] с доставкой по России?»
  4. **Гарантия** — «Какая гарантия на технику Xiaomi в GOODMi?»
...
```json
{
  ...
  "@type": "HowTo",
  "name": "Как купить [категория] Xiaomi с доставкой по России",
...
```json
{
  ...
  "description": "Трейд-ин в GOODMi: оцените старое устройство и получите скидку на новое Xiaomi.",
  "step": [
    {
      "@type": "HowToStep",
      "position": 1,
...
<div class="gm-block" itemscope itemtype="https://schema.org/WebPage">
  ...
  <section class="gm-faq" aria-labelledby="faq-heading">
    <h3 id="faq-heading" class="gm-section-title">Вопросы о [категория] Xiaomi</h3>

    <!-- Вопрос 1: информационный (новый в v2) -->
    <div class="gm-faq-item">
      <p class="gm-faq-question">Что важно учесть при выборе [категория] Xiaomi?</p>
    ...
    <!-- Вопрос 3: доставка -->
    <div class="gm-faq-item">
      <p class="gm-faq-question">Как купить [категория] Xiaomi с доставкой по России?</p>
      <div class="gm-faq-answer">
    ...
    <!-- Вопрос 4: гарантия -->
    <div class="gm-faq-item">
      <p class="gm-faq-question">Какая гарантия на [категория] Xiaomi в GOODMi?</p>
      <div class="gm-faq-answer">
    ...
    <div class="gm-block">  <!-- без itemscope! -->
      ...
      <div class="gm-cta">
        <div class="gm-cta-text">
          ...
          <p>Наши консультанты помогут подобрать [категория] Xiaomi под ваши задачи и бюджет.</p>
        </div>
...
<script type="application/ld+json">
{
  ...
  "description": "GOODMi — фирменный магазин техники Xiaomi в Крыму с 2016 года. Самовывоз в 6 точках: 4 в Севастополе, Симферополь, Ялта. Доставка СДЭК по всей России, трейд-ин, покупка в кредит.",
  "sameAs": [
    "https://yandex.ru/maps/org/goodmi/81345582117/"
  ],
  "alternateName": ["Магазин Xiaomi GOODMi", "Магазин Сяоми GOODMi", "[Категория] Сяоми Крым", "Купить Сяоми Севастополь"],
  "address": {
    "@type": "PostalAddress",
...
- [ ] **[v2] `LocalBusiness.sameAs`** содержит `"https://yandex.ru/maps/org/goodmi/81345582117/"`
...
- [ ] Лид `.gm-intro-text` содержит «Xiaomi (Сяоми)» или аналог
- [ ] Один вопрос FAQ — с кириллическим написанием бренда
